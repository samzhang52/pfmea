...
export const DEFAULT_PFMEA_COLUMNS = [
  { key: 'stepNo', label: '工序号', type: 'number', description: '文件中的步骤编号' },
  { key: 'station', label: '工站', type: 'text', description: '文件中的工站名' },
  { key: 'processFunction', label: '过程功能', type: 'text', description: '该工序"做什么"' },
  { key: 'requirement', label: '要求', type: 'text', description: '填写该工序必须满足的技术参数或质量标准' },
  { key: 'failureMode', label: '潜在失效模式', type: 'text', description: '功能丧失或下降的具体表现' },
  { key: 'failureEffect', label: '潜在失效后果', type: 'text', description: '对本工序下游 / 最终客户的影响' },
  { key: 'severity', label: '严重度S', type: 'number', description: '根据评分标准打分' },
  { key: 'cause', label: '潜在的失效起因/机理', type: 'text', description: '导致失效的根因（人/机/料/法/环）' },
  { key: 'occurrence', label: '频度数O', type: 'number', description: '根据评分标准打分' },
  { key: 'preventionControl', label: '现行预防过程控制', type: 'text', description: '现行预防过程控制：事前防根因发生的措施（点检、培训、防错等）' },
  { key: 'detectionControl', label: '现行探测过程控制', type: 'text', description: '事后发现失效的措施（自检、AOI、巡检、测试等）' },
  { key: 'detection', label: '可探测度D', type: 'number', description: '根据评分标准打分' },
  { key: 'so', label: '风险顺序数SO', type: 'number', autoCalc: true, description: 'S*O' },
  { key: 'rpn', label: '风险顺序数RPN', type: 'number', autoCalc: true, description: '分数不可高于100' },
  { key: 'recommendedAction', label: '建议措施', type: 'text', description: '针对高 RPN 条目的具体改进行动（改设备/工装/参数/检测）' },
];
